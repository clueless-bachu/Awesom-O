...
class ControllerTest {
 ...
 public:
    ...
    */
explicit ControllerTest(const ros::NodeHandle &n)
        : nh_(n) {
        sub_cmd_vel_ = nh_.subscribe("/cmd_vel",
                                     1, &ControllerTest::CmdVelCallback, this);
        sub_goal_ack_ = nh_.subscribe
        ("/goal_ack", 1, &ControllerTest::GoalAckCallback, this);
    ...
    */
    void publish(nav_msgs::Odometry odom_msg,
     geometry_msgs::Pose2D goal_msg, int max_count) {
